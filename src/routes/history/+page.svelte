<script lang="ts">
  ...
  import { Globe as GlobeIcon, History as HistoryIcon } from "@lucide/svelte";
      ...
      <div class="flex flex-col min-h-[calc(100vh-8rem)]">
        ...
        <div class="flex items-center justify-between border-b border-neutral-200 px-4 py-3 dark:border-neutral-800">
          <div class="flex items-center space-x-2 text-neutral-500 dark:text-neutral-400">
            ...
            <p class="text-sm">
              <span class="font-mono">Scan</span>
              <span>History</span>
            </p>
          </div>
        ...
        <div class="p-6">
          <div class="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            <div class="space-y-1">
              <h1 class="text-4xl font-bold tracking-tight dark:text-white">Scan History</h1>
              <p class="text-neutral-500 dark:text-neutral-400">Your recently inspected websites.</p>
            </div>
          ...
          {#if $history.length === 0}
            <div class="flex flex-col items-center justify-center py-24 text-center">
              <div class="mb-4 rounded-full bg-neutral-100 p-6 dark:bg-neutral-800">
                <HistoryIcon size={40} class="text-neutral-400" />
              </div>
              <h2 class="text-xl font-bold dark:text-white">No history yet</h2>
              <p class="mt-2 text-neutral-500">Your recent scans will appear here automatically.</p>
              <Button href="/" class="mt-8">Scan a Website</Button>
            </div>
          {:else}
