...
<svelte:head>
  {#if report}
    ...
    <meta property="og:image" content="https://siteglow.xtra.wtf/webdna_og_image.png" />
    ...
    <meta property="twitter:image" content="https://siteglow.xtra.wtf/webdna_og_image.png" />
  {:else}
