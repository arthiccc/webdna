...
<div class="my-6 flex flex-col space-y-2 px-2 font-mono">
	<div class="p-px">
		<div
			class="flex min-h-[calc(100vh-4rem)] flex-col overflow-y-auto border border-[var(--whois-border)] bg-[var(--whois-bg)] px-8 pt-24 pb-12 md:px-16 md:pt-32 lg:px-24 lg:pt-40"
		>
			<div class="mb-16">
				<h1
					class="mb-4 text-5xl font-black uppercase tracking-tight text-[var(--whois-text)] md:text-7xl"
				>
					About <span class="text-[var(--whois-accent)]">Us</span>
				</h1>
				<div class="h-1 w-24 bg-[var(--whois-accent)]"></div>
			</div>
			...
			<div class="grid grid-cols-1 gap-12 md:grid-cols-2">
				...
				>
					...
					<p class="mb-8 text-base font-medium leading-relaxed text-[var(--whois-text-muted)]">
						Owner and main developer for WebDNA.
					</p>
