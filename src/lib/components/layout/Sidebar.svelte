...
<aside
  class={cn(
    ...
    "w-56 hidden flex-col space-y-4 md:flex z-50",
...
>
    ...
    {#each links as link}
      <a
        ...
        class={cn(
          ...
          page.url.pathname === link.href && "bg-neutral-200 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-100"
        )}
      >
  ...
  {#if $history.length > 0}
    <div class="mt-4 px-2">
      ...
      <h3 class="mb-2 px-2 text-xs font-semibold uppercase tracking-wider text-neutral-400 dark:text-neutral-500">
        Recent
      </h3>
